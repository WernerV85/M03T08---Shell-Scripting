...
SECRET_KEY = ('django-insecure-$m_$2dvj#@lqjk(3*g!^v2ykpg7o08=%3ao6j)s^'
              'f8j=cgm*lx')
...
# Adding static files directory for tasks app
STATICFILES_DIRS = [BASE_DIR / "tasks/static",
                    # Adding static files directory for todo_list app
